 ...
 */
export function seedSettings(db, values) {
  ...
  for (const [key, plain] of Object.entries(values)) {
    stmt.run(key, encryptValue(String(plain)), GROUP[key] ?? "MISC", now, now);
  }
}

/** Bộ cài đặt tiêu chuẩn trỏ về các mock server dùng trong test. */
